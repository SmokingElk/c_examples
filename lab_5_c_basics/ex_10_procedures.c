...
void printFactorial (int x) {
    ...
    // обратите внимание, else не требуется, после return выполнение завершается
    // следует писать именно так, чтобы не создавать лишней вложенности для основной части тела
